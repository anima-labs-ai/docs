...
| Starter | `$29/mo` | 25 | 10K / mo | 1 included, then `$2/mo` each | 500 out + 500 in / mo | 100 Basic + 10 Premium min | 250 / mo | 500 credentials |
...
Free is hard-capped and requires no credit card; it also includes 5 GB attachment storage and full MCP server access. Phone numbers, SMS, and voice start on Starter. Paid tiers use the unit rates below when usage exceeds the included quota.
