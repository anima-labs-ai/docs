...
| ----------------------------------------- | ------ | ------------------------------- |
| `/api/wallet`                             | POST   | Create a wallet                 |
| `/api/wallet/:id`                         | GET    | Get wallet details and balance  |
| `/api/wallet/:id/budget-guards`           | PUT    | Update budget guards            |
| `/api/wallet/:id/pay`                     | POST   | Initiate a payment              |
| `/api/wallet/:id/transactions`            | GET    | List transactions               |
| `/api/wallet/:id/x402`                    | POST   | Make an x402 payment            |
...
- [Card Controls](/docs/cards/controls) -- Fine-grained card spending controls
- [A2A Protocol](/docs/a2a/overview) -- Agent-to-agent payments and task delegation
- [Audit Log](/docs/security/audit-log) -- Track all wallet transactions
