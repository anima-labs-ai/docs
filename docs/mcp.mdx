...
Anima exposes over 77 specialized tools via the [Model Context Protocol](https://modelcontextprotocol.io) (MCP), giving AI assistants direct access to agent email, virtual cards, vault, phone, voice calls, and more.

Tools are organized into **6 domain servers**, so you can install only what you need:
...
| **Cards** | `@anima-labs/mcp-cards` | Virtual cards, wallet, funding, invoices, browser payments, x402 |
...
| Category | Tools | Description |
|----------|-------|-------------|
| **Cards** | create, list, get, freeze, close, policies | Virtual card issuing |
| **Wallet** | balance, list-transactions | Wallet operations |
| **Funding** | list, create | Funding source management |
| **Invoice** | create, list, match | Invoice tracking |
| **Browser Payments** | detect, fill, pay | Automated checkout |
| **x402** | payment protocols | HTTP 402 payment protocol |
...
- "Create a virtual card with a $50 daily limit" → **mcp-cards**
- "Store my CRM login credentials in the vault" → **mcp-vault**
- "Make a voice call to +1-555-0123" → **mcp-phone**
- "List all transactions on card **** 4242" → **mcp-cards**
