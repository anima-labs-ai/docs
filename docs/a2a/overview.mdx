...
| `/api/a2a/tasks/:id/cancel`       | POST   | Cancel a pending/in-progress task|
...
- [Agent Cards](/docs/identity/agent-cards) -- Publish capabilities for discovery
- [Agent Registry](/docs/registry/overview) -- Find agents to delegate tasks to
- [Agent Wallet](/docs/wallet/overview) -- Attach payments to task delegations
