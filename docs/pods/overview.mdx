...
| ------------------------------------- | ------ | ------------------------------- |
| `/api/pods`                           | POST   | Create a pod                    |
| `/api/pods`                           | GET    | List all pods                   |
| `/api/pods/:id`                       | GET    | Get pod details                 |
| `/api/pods/:id`                       | PUT    | Update pod settings             |
| `/api/pods/:id`                       | DELETE | Delete a pod                    |
| `/api/pods/:id/api-keys`              | POST   | Create a pod-scoped API key     |
| `/api/pods/:id/api-keys`              | GET    | List pod API keys               |
| `/api/pods/:id/stats`                 | GET    | Get pod usage statistics        |
| `/api/pods/bridges`                   | POST   | Create a cross-pod bridge       |
