...
| ------------------------------------- | ----------------------------------- |
| `GET api/audit-log/events`            | Query audit events                  |
| `GET api/audit-log/events/{id}`       | Get a single audit event            |
| `POST api/audit-log/export`           | Start an export job                 |
| `GET api/audit-log/export/{id}`       | Check export job status             |
| `POST api/audit-log/siem`             | Configure SIEM streaming            |
| `GET api/audit-log/siem`              | Get SIEM configuration              |
