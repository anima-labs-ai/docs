  ...
  "service": [
    {
      ...
      "type": "AgentEmail",
      "serviceEndpoint": "mailto:agent@acme.anima.email"
    },
    {
      "id": "did:anima:ag_8f3k2m9x1n4p7q6r#a2a",
      "type": "AgentToAgent",
      "serviceEndpoint": "https://acme.anima.email/.well-known/agent.json"
    }
  ]
}
```
...
```bash
curl https://api.anima.email/v1/identity/did/did:anima:ag_8f3k2m9x1n4p7q6r
```
...
```json
{
  "@context": [
    ...
    "https://anima.email/credentials/v1"
  ],
  ...
  "credentialSubject": {
    ...
    "capabilities": ["email", "phone", "cards", "vault"],
    "spendingLimitDaily": 50000,
    "complianceStatus": "kyb_verified"
  },
  "proof": {
...
3. That the organization has completed KYB verification
4. What capabilities and spending limits the agent has
