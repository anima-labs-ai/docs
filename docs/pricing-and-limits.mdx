...
Outbound voice calls are limited by both minutes and call count. The count cap exists because a loop of very short calls can rack up per-call exposure long before a minute cap notices.
