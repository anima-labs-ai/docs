...
- [WebSocket Protocol](/protocols/voice-websocket) — Full protocol reference for real-time events
- [MCP Setup](/mcp) — Use voice calls from Claude Desktop and other AI tools
