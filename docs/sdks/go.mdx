---
title: "Go SDK"
description: "Quickstart and reference for the Anima Go SDK. Manage agents, email, cards, vault, identity, and A2A from Go applications."
---

# Go SDK

The official Anima Go SDK provides idiomatic Go access to the full Anima platform: agents, email, cards, vault, identity, wallet, registry, and A2A.
...
card, err := client.Cards.Create(ctx, &anima.CreateCardParams{
    ...
    Currency:       "usd",
    SpendLimitDaily: 50000, // cents
})

// Get card details
card, err := client.Cards.Get(ctx, "card_abc123")

// List transactions
txns, err := client.Cards.ListTransactions(ctx, "card_abc123", &anima.ListTransactionsParams{
    Limit: 20,
})

// Close a card
err := client.Cards.Close(ctx, "card_abc123")
```
...
- [Official SDKs](/docs/sdks) -- TypeScript and Python SDK documentation
- [Getting Started](/docs/getting-started) -- Platform quickstart guide
